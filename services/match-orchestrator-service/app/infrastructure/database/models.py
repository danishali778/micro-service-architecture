...
class MatchModel(Base):
    ...
    creation_request_hash: Mapped[str | None] = mapped_column(String(128), nullable=True)
    red_run_id: Mapped[str | None] = mapped_column(String(80), nullable=True)
    red_run_state: Mapped[str | None] = mapped_column(String(40), nullable=True)
    red_agent_adapter: Mapped[str | None] = mapped_column(String(80), nullable=True)
    red_agent_profile_ref: Mapped[str | None] = mapped_column(String(160), nullable=True)
    attack_proposal_id: Mapped[str | None] = mapped_column(String(80), nullable=True)
    attack_proposal: Mapped[dict[str, Any] | None] = mapped_column(JSON_DOCUMENT, nullable=True)
