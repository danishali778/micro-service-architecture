...
from app.core.exceptions import MatchServiceError
...
def install_exception_handlers(app: FastAPI) -> None:
    @app.exception_handler(MatchServiceError)
    async def service_error_handler(request: Request, error: MatchServiceError) -> JSONResponse:
        return _response(
            request=request,
