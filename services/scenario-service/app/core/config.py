...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="scenario-service", validation_alias="SERVICE_NAME")
    ...
    database_url: str = Field(
        default="postgresql+psycopg://scenario_service:scenario_service@127.0.0.1:5432/scenario_service",
    ...
    default_page_size: int = Field(default=50, ge=1, le=100, validation_alias="DEFAULT_PAGE_SIZE")
    max_page_size: int = Field(default=100, ge=1, le=100, validation_alias="MAX_PAGE_SIZE")
